...
class TestSagemcomRestClient(unittest.TestCase):
    ...
    @patch(
        "shared_resources.sagemcom_client.SagemcomRestClient._get_password_from_1password"
    )
    ...
    @patch("requests.post")
    @patch(
        "shared_resources.sagemcom_client.SagemcomRestClient._get_password",
                ...
                "rules": [
                    {
                        "id": 1,
                        "rule": {
                            "localAddress": "192.168.178.10",
                            "localStartPort": 80,
                            "externalStartPort": 8080,
                            "protocol": "tcp",
                            "enable": True,
                        },
                    },
                    {
                        "id": 2,
                        "rule": {
                            "localAddress": "192.168.178.11",
                            "localStartPort": 22,
                            "externalStartPort": 2222,
                            "protocol": "tcp_udp",
                            "enable": False,
                        },
                    },
    ...
    def test_add_port_forward(self, mock_post):
        ...
        expected_payload = {
            "rule": {
                "localAddress": "192.168.178.20",
                "localStartPort": 3000,
                "localEndPort": 3000,
                "externalStartPort": 4000,
                "externalEndPort": 4000,
                "protocol": "udp",
                "enable": True,
            }
        }
